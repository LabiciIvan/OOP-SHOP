...
<div class="order-details-wrapper">
        ...
        <div class="order-commands">
            ...
            <form class="order-form" action="../includes/order.handler.php" method="POST">
                <button class="order-button confirm" value="<?php echo $order[0]['id'] ?>" name="confirm"> Confirm  <i class="fa-solid fa-check"></i></button>
            </form>
            <form class="order-form" action="../includes/order.handler.php" method="POST">
                <button class="order-button cancel" value="<?php echo $order[0]['id'] ?>" name="cancel">Cancel <i class="fa-solid fa-ban"></i> </button>
            </form>
